...
% RMSE sweep
N_list = [20 50 100 250 500 1000 2500 5000 10000]; % number of roots for stochastic sim
...
for a = 1:length(dC_width_list)
    ...
    plot(N_list,RMSE(a,:),mk,...
        ...
        'LineWidth',lw,...
        'DisplayName',sprintf('\\Delta X = %.2f simulation',dx));

    plot(Nfit,RMSE_fit,ls,...
        'LineWidth',lw,...
        'DisplayName',sprintf('\\Delta X = %.2f fit',dx));
end
...
s.par.lam_life = 1.5; % lifespan rate for root replacement
